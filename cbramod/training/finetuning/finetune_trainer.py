...
"""
CLAUDE-ENHANCED TIER-A PROTO ICL IMPLEMENTATION
...
class Trainer(object):
    def __init__(self, params, data_loader, model):
        ...
        # In-Context Learning (ICL) config
        ...
        # Separate ICL head parameters for different learning rate
        icl_params = []
        if self.icl_head is not None:
        ...
        if self.params.optimizer == 'AdamW':
            if self.params.multi_lr:
                ...
                # Add ICL head with conservative learning rate
                if icl_params:
        ...
        # CLAUDE-ENHANCEMENT: Compute global prototypes for Proto ICL enhancement
        self.global_protos = None
        if hasattr(params, 'icl_mode') and params.icl_mode == 'proto':
            self._compute_global_protos()
            
        # CLAUDE-ENHANCEMENT: Metric-friendly training parameters
    ...
    def _get_global_class_prototype(self, class_id, feature_dim, device, subject_mean=None):
    ...
    def _compute_shrunk_prototypes(self, support_features, support_labels, num_classes, 
    ...
    def _tune_temperature_loo(self, support_features, support_labels, prototypes, 
    ...
    def _compute_prediction_confidence(self, query_features, prototypes, temperature):
        """
    ...
    def _apply_confidence_fallback(self, proto_preds, baseline_preds, confidences, 
    ...
    def _create_episodic_batch_cnp(self, batch, n_way=None, k_shot=5, q_query=10):
        """
    ...
    def _compute_prototypical_loss(self, support_features, support_labels, 
    ...
    def _create_episodic_batch(self, batch, n_way=5, k_shot=5, q_query=10):
        """
    ...
    def _compute_metric_friendly_loss(self, x, y, use_contrastive=True, use_prototypical=True,
    ...
    @torch.no_grad()
    def _icl_eval_Ks(self, loader, K_list, split_name="test"):
        """
    ...
    def train_for_multiclass(self, trial=None):
        ...
        for epoch in range(self.params.epochs):
            ...
            for batch_idx, batch in enumerate(tqdm(self.data_loader['train'], mininterval=10)):
                ...
                if self.icl_mode in ['cnp', 'set'] and self.icl_head is not None:
                ...
                elif self.use_metric_friendly_training:
        ...
        with torch.no_grad():
            ...
            # ==== Optional: K-shot ICL Evaluation ====
