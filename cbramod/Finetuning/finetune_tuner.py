...
def objective(trial, base_params):
    ...
    params.batch_size = trial.suggest_categorical("batch_size", [512, 1024]) #512, 1024,
    params.clip_value = trial.suggest_float("clip_value", 0.0, 2, step=0.01)
    ...
    params.data_ORP = trial.suggest_float("data_ORP", 0.1,0.6, step=0.1)

    # Pretrained weights
    params.foundation_dir = trial.suggest_categorical(
        "foundation_dir", [
            #"optuna_ckpts/BEST__loss8698.99.pth",
            "./cbramod/weights/BEST__loss10527.31.pth",
